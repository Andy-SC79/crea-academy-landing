    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid min-w-0 gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div className="min-w-0 text-center lg:sticky lg:top-28 lg:text-left">
            ...
            <div className="mx-auto mt-8 grid max-w-xl grid-cols-2 gap-3 sm:grid-cols-3 lg:mx-0">
              ...
              <a
                ...
                className="group col-span-2 rounded-lg border border-brand-neon/25 bg-brand-neon/10 p-4 text-sm font-black text-[color:var(--tour-text-strong)] transition-colors hover:border-brand-cyan/45 hover:bg-brand-cyan/10 sm:col-span-1"
              >
