  ...
  return (
    ...
    >
      ...
      <div className="relative flex min-w-0 max-w-full items-center gap-3 sm:gap-4">
        ...
        <span className="min-w-0 truncate pt-1 font-display text-[var(--text-xs)] font-black uppercase tracking-[0.18em] text-[color:var(--tour-text-default)] dark:text-white dark:drop-shadow-sm sm:text-[var(--text-sm)] sm:tracking-[0.25em]">
          {animatedChildren}
        </span>
      </div>
    </div>
