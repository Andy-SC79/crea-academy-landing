  ...
  const pricingTiers: PricingTier[] = [
    {
      ...
      ctaHref: "mailto:contact@crea-academy.com?subject=Registro%20Gratuito",
      ctaIcon: ArrowRight,
      ctaStyle: "ghost",
      featureTone: "brand",
      features: [
    ...
    },
    {
      ...
      ctaHref: "mailto:contact@crea-academy.com?subject=Plan%20Creadores",
      ctaIcon: Zap,
      ctaStyle: "solid",
      featureTone: "brand",
      features: [
      ...
      <div className={PRICING_SECTION_CLASS}>
        ...
        <div className="relative z-10 px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            >
              <p className="text-[11px] font-display font-semibold uppercase tracking-[0.18em] text-brand-neon/80">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      {tier.badge ? (
                        <div className="absolute right-4 top-4 z-20">
                          <span className="inline-flex whitespace-nowrap rounded-full border border-brand-neon/50 bg-brand-neon/10 px-3 py-1 text-[10px] font-display font-semibold uppercase tracking-[0.16em] text-brand-neon shadow-[0_0_15px_rgba(4,255,141,0.2)] md:text-[11px]">
                            {tier.badge}
                          </span>
                        </div>
                      ) : null}
